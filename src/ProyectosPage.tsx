    ...
    <div style={{ background: C.bg, minHeight: '100vh' }}>
      ...
      <header style={{
        ...
        <a href="/" style={{ display: 'flex', alignItems: 'center' }}>
          <img src="/maigia-logo-girasomnis.png" alt="MAIGIA by Girasomnis" style={{ height: 92, width: 'auto' }} />
        </a>
      ...
      <FxSlider items={getProjects(lang)} headerText={lang === 'es' ? 'Proyectos' : 'Projects'} categoryLabel={lang === 'es' ? 'Categoría' : 'Category'} duration={0.64} parallaxAmount={5} />
    </div>
  )
}
